...
parser.add_argument("--cfg_file", type=str, default="/kaggle/working/FUnIE_Attention/PyTorch/configs/train_euvp.yaml")
...
parser.add_argument("--num_epochs", type=int, default=70, help="number of epochs of training") #200
parser.add_argument("--batch_size", type=int, default=4, help="size of the batches") #8
